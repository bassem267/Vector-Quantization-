...
public class VectorQuantization {
    ...
    public static void closeFile() { out.close(); }
    ...
    static void Decompress() {
        ...
        writeImage(Decompressed_image, "D:\\college\\Data Compression\\Decompress.jpg", Decompressed_image[0].length, Decompressed_image.length);
    ...
    public static void main(String[] args) {
        ...
        int bits = 3;
        int levels = (int) Math.pow(bits , 2);
        System.out.println("Enter Width: ");
        int width = myObj.nextInt();
        System.out.println("Enter Height: ");
        int height = myObj.nextInt();
        originalImage = readImage("D600x600.jpg");

        int numOfRows = originalImage.length / height;
        int numOfCols = originalImage[0].length / width;
